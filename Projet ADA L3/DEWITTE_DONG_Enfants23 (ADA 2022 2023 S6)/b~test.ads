...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#352020f8#;
   ...
   u00134 : constant Version_32 := 16#ffb485a5#;
   pragma Export (C, u00134, "gestion_baby_sitterB");
   u00135 : constant Version_32 := 16#206741d2#;
   pragma Export (C, u00135, "gestion_baby_sitterS");
   u00136 : constant Version_32 := 16#acee74ad#;
   pragma Export (C, u00136, "system__compare_array_unsigned_8B");
   u00137 : constant Version_32 := 16#9ba3f0b5#;
   pragma Export (C, u00137, "system__compare_array_unsigned_8S");
   u00138 : constant Version_32 := 16#a8025f3c#;
   pragma Export (C, u00138, "system__address_operationsB");
   u00139 : constant Version_32 := 16#21ac3f0b#;
   pragma Export (C, u00139, "system__address_operationsS");
   u00140 : constant Version_32 := 16#b31a5821#;
   pragma Export (C, u00140, "system__img_enum_newB");
   u00141 : constant Version_32 := 16#53ec87f8#;
   pragma Export (C, u00141, "system__img_enum_newS");
   u00142 : constant Version_32 := 16#d9d8e16a#;
   pragma Export (C, u00142, "outilsB");
   u00143 : constant Version_32 := 16#bd0e0ed2#;
   pragma Export (C, u00143, "outilsS");
   u00144 : constant Version_32 := 16#1cb84c7d#;
   pragma Export (C, u00144, "gestion_familleB");
   u00145 : constant Version_32 := 16#087f6db8#;
   pragma Export (C, u00145, "gestion_familleS");
   u00146 : constant Version_32 := 16#3a8ad7ea#;
   pragma Export (C, u00146, "gestion_gardeB");
   u00147 : constant Version_32 := 16#55518e3a#;
   pragma Export (C, u00147, "gestion_gardeS");
   u00148 : constant Version_32 := 16#97524d68#;
   pragma Export (C, u00148, "initialisationB");
   u00149 : constant Version_32 := 16#fc74ee76#;
   pragma Export (C, u00149, "initialisationS");
   ...
   --  outils%s
   --  outils%b
   --  gestion_baby_sitter%s
   --  gestion_baby_sitter%b
   --  gestion_famille%s
   --  gestion_famille%b
   --  gestion_garde%s
   --  gestion_garde%b
