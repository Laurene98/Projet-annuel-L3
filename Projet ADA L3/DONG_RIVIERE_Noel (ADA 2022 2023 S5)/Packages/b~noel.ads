...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_noel" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#71672e04#;
   pragma Export (C, u00001, "noelB");
   ...
   u00149 : constant Version_32 := 16#4cf886c6#;
   pragma Export (C, u00149, "gestion_activitesB");
   u00150 : constant Version_32 := 16#2de8de18#;
   pragma Export (C, u00150, "gestion_activitesS");
   ...
   u00153 : constant Version_32 := 16#4d20150a#;
   pragma Export (C, u00153, "outilsS");
   u00154 : constant Version_32 := 16#1f9c8c53#;
   pragma Export (C, u00154, "gestion_elfesB");
   u00155 : constant Version_32 := 16#71c6916d#;
   pragma Export (C, u00155, "gestion_elfesS");
   u00156 : constant Version_32 := 16#33e0ea4a#;
   pragma Export (C, u00156, "gestion_locataireB");
   u00157 : constant Version_32 := 16#2b789270#;
   pragma Export (C, u00157, "gestion_locataireS");
   u00158 : constant Version_32 := 16#4ceb98ec#;
   pragma Export (C, u00158, "gestion_kdoB");
   u00159 : constant Version_32 := 16#21387e47#;
   pragma Export (C, u00159, "gestion_kdoS");
   u00160 : constant Version_32 := 16#501096c8#;
   pragma Export (C, u00160, "aleatoireB");
   u00161 : constant Version_32 := 16#3764af37#;
   pragma Export (C, u00161, "aleatoireS");
   u00162 : constant Version_32 := 16#01ea2419#;
   ...
   u00165 : constant Version_32 := 16#a99e1d66#;
   pragma Export (C, u00165, "system__os_primitivesB");
   u00166 : constant Version_32 := 16#b82f904e#;
   pragma Export (C, u00166, "system__os_primitivesS");
   u00167 : constant Version_32 := 16#b6166bc6#;
   ...
   u00170 : constant Version_32 := 16#c4890131#;
   pragma Export (C, u00170, "system__arith_64B");
   u00171 : constant Version_32 := 16#285876a2#;
   pragma Export (C, u00171, "system__arith_64S");
   u00172 : constant Version_32 := 16#83947c18#;
   pragma Export (C, u00172, "system__val_enumB");
   u00173 : constant Version_32 := 16#89bac3ad#;
   pragma Export (C, u00173, "system__val_enumS");
   u00174 : constant Version_32 := 16#dd06492b#;
   pragma Export (C, u00174, "gestion_fichierB");
   u00175 : constant Version_32 := 16#9c0a1f15#;
   pragma Export (C, u00175, "gestion_fichierS");
   u00176 : constant Version_32 := 16#55a2bddf#;
   pragma Export (C, u00176, "gestion_iglooB");
   u00177 : constant Version_32 := 16#b7f7dc33#;
   pragma Export (C, u00177, "gestion_iglooS");
   u00178 : constant Version_32 := 16#4b3cf578#;
   pragma Export (C, u00178, "system__byte_swappingS");
   u00179 : constant Version_32 := 16#796b5f0d#;
   pragma Export (C, u00179, "system__sequential_ioB");
   u00180 : constant Version_32 := 16#d8cc2bc8#;
   pragma Export (C, u00180, "system__sequential_ioS");
