...
<html lang="fr">
  ...
  <body>
    ...
    <?php
      ...
      $sql = "SELECT * FROM Service WHERE CategorieS LIKE '%Salle_de_fete%'";

      // Exécuter la requête SQL
      $stmt = $bdd->query($sql);        
    ?>
    <!----------------- Péparation requete (fin)----------------->
    <!----------------- Liste de service Salle de fêtes (début)----------------->
    <div class="tout">     
    ...
    <!----------------- Liste de service Salle de fêtes (fin)------------------->
  </body>
</html>
